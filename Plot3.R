...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>ExploratoryAnalysis/Plot3.R at master · ramdevender/ExploratoryAnalysis</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/7321805?s=400" property="og:image" /><meta content="ramdevender/ExploratoryAnalysis" property="og:title" /><meta content="https://github.com/ramdevender/ExploratoryAnalysis" property="og:url" /><meta content="ExploratoryAnalysis - Exploratory Data Analysis" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4C7490B8:18CF:410980E:53C30844" name="octolytics-dimension-request_id" /><meta content="7343536" name="octolytics-actor-id" /><meta content="samsonpaulk" name="octolytics-actor-login" /><meta content="ec126e46b0663b00874eb24a2750130d9ebaff81834c357321bb197a4d0707b7" name="octolytics-actor-hash" />
...
<meta content="tOvmFJavbBrfTHV1D348c4eQH6qEG1nufZxGk2JwLuLm2ovW+jquk9iOtGtQ5MsFF4VLPWytRqb/EJXhSy6TDQ==" name="csrf-token" />
...
<ul id="user-links">
  ...
  <li>
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="n2XuO3tyafONlwRVyKQ4kvK53EjU1fcpjR2gIqnKhwKBag0Ibgws9iK9iZOrRhZDXL7YFAlGzHvB47bC6kUOIw==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="jzuhgal8Wbz78oIywtHUXzv0f7kPrj5VPKy8k0+xXnPirKAozSq5wCVB4CwA1hrB36LpAqP9y+KYteqWBkHyJg==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="21799316" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/ramdevender/ExploratoryAnalysis/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="DeOixzLm6yWbiEY/ZA/4qe/rSPPSQD5nBTVbSww4HVywxmCGxptKpxNky2kQAaagrsKdbl/I2/NmzoQr6k3WuA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/ramdevender/ExploratoryAnalysis/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="JNxToQePExNNPWYqL+KWktysszdHes/4W9zVjTQU0Ag6Nke1FbOJlLeviYiCRwveI6CpAwsFBpmuX/lRbyZNMw==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/ramdevender/ExploratoryAnalysis/blob/1570bf33a138ec63e3a78c0eb69ae8560b07e73c/Plot3.R" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:601b95bc091f045a61d24a1bb2f68c41 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/ramdevender/ExploratoryAnalysis/blob/master/Plot3.R"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/ramdevender/ExploratoryAnalysis/contributors/master/Plot3.R">
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped tooltipped-w"
               href="github-windows://openRepo/https://github.com/ramdevender/ExploratoryAnalysis?branch=master&amp;filepath=Plot3.R" aria-label="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton tooltipped tooltipped-n js-update-url-with-hash"
                   aria-label="Clicking this button will automatically fork this project so you can edit the file"
                   href="/ramdevender/ExploratoryAnalysis/edit/master/Plot3.R"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/ramdevender/ExploratoryAnalysis/raw/master/Plot3.R" class="minibutton " id="raw-url">Raw</a>
            <a href="/ramdevender/ExploratoryAnalysis/blame/master/Plot3.R" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/ramdevender/ExploratoryAnalysis/commits/master/Plot3.R" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon tooltipped tooltipped-s"
               href="/ramdevender/ExploratoryAnalysis/delete/master/Plot3.R"
...
<span id="L13" rel="#L13">13</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'>consumption <span class="o">&lt;-</span> read.csv<span class="p">(</span><span class="s">&quot;./household_power_consumption.txt&quot;</span><span class="p">,</span>sep<span class="o">=</span><span class="s">&quot;;&quot;</span><span class="p">,</span>na.strings<span class="o">=</span><span class="s">&#39;?&#39;</span><span class="p">,</span>header<span class="o">=</span><span class="kc">TRUE</span><span class="p">,</span>colClasses <span class="o">=</span> <span class="kt">c</span><span class="p">(</span><span class="s">&quot;character&quot;</span><span class="p">,</span><span class="kp">rep</span><span class="p">(</span><span class="s">&quot;factor&quot;</span><span class="p">,</span><span class="m">1</span><span class="p">),</span><span class="kp">rep</span><span class="p">(</span><span class="s">&quot;numeric&quot;</span><span class="p">,</span><span class="m">7</span><span class="p">)))</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'>selection<span class="o">&lt;-</span>consumption<span class="p">[</span>consumption<span class="o">$</span>Date <span class="o">%in%</span> <span class="kt">c</span><span class="p">(</span><span class="s">&quot;1/2/2007&quot;</span><span class="p">,</span><span class="s">&quot;2/2/2007&quot;</span><span class="p">),]</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>plot<span class="p">(</span><span class="kp">strptime</span><span class="p">(</span><span class="kp">paste</span><span class="p">(</span>selection<span class="o">$</span>Date<span class="p">,</span>selection<span class="o">$</span>Time<span class="p">),</span><span class="s">&quot;%d/%m/%Y %H:%M:%S&quot;</span><span class="p">),</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;selection<span class="o">$</span>Sub_metering_1<span class="p">,</span>ylab<span class="o">=</span><span class="s">&quot;Energy sub metering&quot;</span><span class="p">,</span>xlab<span class="o">=</span><span class="s">&quot;&quot;</span><span class="p">,</span>type<span class="o">=</span><span class="s">&quot;l&quot;</span><span class="p">)</span></div><div class='line' id='LC7'>lines<span class="p">(</span><span class="kp">strptime</span><span class="p">(</span><span class="kp">paste</span><span class="p">(</span>selection<span class="o">$</span>Date<span class="p">,</span>selection<span class="o">$</span>Time<span class="p">),</span><span class="s">&quot;%d/%m/%Y %H:%M:%S&quot;</span><span class="p">),</span>selection<span class="o">$</span>Sub_metering_2<span class="p">,</span>col<span class="o">=</span><span class="s">&quot;red&quot;</span><span class="p">)</span></div><div class='line' id='LC8'>lines<span class="p">(</span><span class="kp">strptime</span><span class="p">(</span><span class="kp">paste</span><span class="p">(</span>selection<span class="o">$</span>Date<span class="p">,</span>selection<span class="o">$</span>Time<span class="p">),</span><span class="s">&quot;%d/%m/%Y %H:%M:%S&quot;</span><span class="p">),</span>selection<span class="o">$</span>Sub_metering_3<span class="p">,</span>col<span class="o">=</span><span class="s">&quot;blue&quot;</span><span class="p">)</span></div><div class='line' id='LC9'>legend<span class="p">(</span>cex<span class="o">=</span><span class="m">0.7</span><span class="p">,</span><span class="s">&quot;topright&quot;</span><span class="p">,</span> lty<span class="o">=</span><span class="kt">c</span><span class="p">(</span><span class="kp">rep</span><span class="p">(</span><span class="m">1</span><span class="p">,</span><span class="m">3</span><span class="p">)),</span> col <span class="o">=</span> <span class="kt">c</span><span class="p">(</span><span class="s">&quot;black&quot;</span><span class="p">,</span><span class="s">&quot;red&quot;</span><span class="p">,</span> <span class="s">&quot;blue&quot;</span><span class="p">),</span> legend <span class="o">=</span> <span class="kt">c</span><span class="p">(</span><span class="s">&quot;Sub_metering_1&quot;</span><span class="p">,</span><span class="s">&quot;Sub_metering_2&quot;</span><span class="p">,</span> <span class="s">&quot;Sub_metering_3&quot;</span><span class="p">))</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>dev.copy<span class="p">(</span>png<span class="p">,</span> file <span class="o">=</span> <span class="s">&quot;plot3.png&quot;</span><span class="p">)</span>  <span class="c1">## copy the plot to a PNG file</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'>dev.off<span class="p">()</span>  <span class="c1">## close PNG device</span></div></pre></div></td>
         </tr>
       </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04025s from github-fe127-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
